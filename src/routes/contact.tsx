      ...
      <section className="container-page py-12">
        ...
        <div className="mt-8 grid gap-10 md:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <div className="mt-10 rounded-lg border border-border bg-[var(--cream)] p-6">
          ...
          <aside>
            <h2 className="m-0 text-xl">Locations</h2>
            <div className="mt-4 space-y-4">
              <article className="rounded-lg border border-border bg-[var(--cream)] p-6">
              ...
              <article className="rounded-lg border border-border bg-[var(--cream)] p-6">
                <address className="not-italic text-base leading-relaxed">
                  <p>Lauderdale Medical Centre, 444 South Arm Road, Lauderdale, Tasmania 7021</p>
                </address>
                <p className="mt-2">
